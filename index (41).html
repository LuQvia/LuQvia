...
<head>
  ...
  <title>パーソナルジム向けHP制作｜サービス詳細｜LuQvia Sample</title>
  <meta name="description" content="パーソナルジム向けに必要なHP構成・掲載内容・導線を整理したサービス詳細ページです。"/>
  <meta property="og:title" content="パーソナルジム向けHP制作｜サービス詳細"/>
  <meta property="og:description" content="パーソナルジム向けに必要なHP構成・掲載内容・導線を整理したサービス詳細ページです。"/>
  <meta property="og:type" content="website"/>
  <meta property="og:image" content="https://YOUR_GITHUB_PAGES_URL/samples/assets/ogp/personal-gym.jpg"/>
  <meta name="twitter:card" content="summary_large_image"/>
  <meta name="twitter:image" content="https://YOUR_GITHUB_PAGES_URL/samples/assets/ogp/personal-gym.jpg"/>
  <link rel="canonical" href="https://YOUR_GITHUB_PAGES_URL/samples/personal-gym/service/"/>
...
<header class="header">
  <div class="container header-inner">
    <a class="logo" href="../../index.html"><span class="logo-mark">L</span><span><strong>LuQvia Sample</strong><small>パーソナルジム</small></span></a>
...
<section class="lower-hero">
  <div class="container">
    <div class="breadcrumb"><a href="../../index.html">サンプル一覧</a><span>/</span><a href="../index.html">パーソナルジム</a><span>/</span><span>パーソナルジム向けHP制作｜サービス詳細</span></div>
    <p class="eyebrow">Lower Page Sample</p>
    <h1>パーソナルジム向けHP制作｜サービス詳細</h1>
    <p class="lead">パーソナルジム向けに必要なHP構成・掲載内容・導線を整理したサービス詳細ページです。</p>
    <div class="actions">
...
<section class="section">
  <div class="container">
    <div class="heading"><p class="eyebrow">Service Detail</p><h2>制作で整える内容</h2><p>Before/After、料金プラン、トレーナー紹介、体験予約導線を整理し、入会前の不安を減らします。</p></div>
    <div class="lower-grid">
      <article class="lower-card"><h3>対象業種</h3><ul class="lower-list"><li>パーソナルジム</li><li>フィットネススタジオ</li><li>ダイエットジム</li><li>ヨガスタジオ</li></ul></article>
      <article class="lower-card"><h3>よくある課題</h3><ul class="lower-list"><li>料金プランが分かりにくい</li><li>成果イメージが伝わりにくい</li><li>体験予約導線が弱い</li></ul></article>
    </div>
  </div>
</section>
<section class="section muted">
  <div class="container">
    <div class="heading"><p class="eyebrow">Contents</p><h2>HPに入れるべき主要コンテンツ</h2><p>比較検討中のユーザーが知りたい情報を先回りして整理します。</p></div>
    <div class="lower-card"><ul class="lower-list"><li>プラン・料金</li><li>Before/After</li><li>トレーナー紹介</li><li>体験の流れ</li><li>LINE相談</li></ul></div>
  </div>
</section>
<section class="section">
  <div class="container lower-cta-box">
    <h2>サービス内容を整理すると、問い合わせ前の不安を減らせます。</h2>
    <p>ただ作るだけではなく、見込み客がどこで迷い、何を確認してから問い合わせるかを設計します。</p>
...
<footer class="footer"><div class="container"><strong>LuQvia Sample</strong><p>パーソナルジム向けHP制作の下層ページサンプル</p></div></footer>
